...
<head>
    ...
    <!--页面标题-->
    <title><?php echo ((isset($pageInfo["title"]) && ($pageInfo["title"] !== ""))?($pageInfo["title"]):"后台"); ?></title>
    ...
    <link rel="stylesheet" type="text/css" href="/RabbitCMS/Public/diavision/css/diavision-admin.css" />
</head>
